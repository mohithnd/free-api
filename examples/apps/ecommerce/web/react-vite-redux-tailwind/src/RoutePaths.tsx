    ...
    <BrowserRouter>
      <Routes>
        <Route path="/" element={<PageLayout />}>
          ...
          <Route
            path={ROUTE_PATHS.productSearch}
            element={<ProductSearchPageContainer />}
          />
          <Route
            path={ROUTE_PATHS.resetForgottenPassword}
            element={<ResetForgottenPasswordPageContainer />}
          />
          <Route element={<ForLoggedInUsers />}>
            <Route path={ROUTE_PATHS.cart} element={<CartPageContainer />} />
            <Route
              path={ROUTE_PATHS.checkout}
              element={<CheckoutPageContainer />}
            />
            <Route
              path={ROUTE_PATHS.paymentFeedback}
              element={<PaymentFeedbackPageContainer />}
            />
            <Route
              path={ROUTE_PATHS.manageAccount}
              element={<ManageAccountPageContainer />}
            />
            <Route
