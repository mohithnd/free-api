...
const AddAddressModal = (props: AddAddressModalProps) => {
  ...
  const countryActionRef = useRef<DropdownActions>({
    forceSetSelectedItem(_) {},
  });
  const stateActionRef = useRef<DropdownActions>({
    forceSetSelectedItem(_) {},
  });
  ...
  useEffect(() => {
    if (initiallySelectedAddress) {
      ...
      countryActionRef.current?.forceSetSelectedItem(
        initiallySelectedAddress.selectedCountry
      );
      stateActionRef.current?.forceSetSelectedItem(
        initiallySelectedAddress.selectedState
      );
      cityActionRef.current.forceSetSelectedItem(
        initiallySelectedAddress.selectedCity
      );
  ...
  return (
    <>
      ...
      <Modal
        heading={
          initiallySelectedAddress ? t("updateAddress") : t("addAddress")
        }
