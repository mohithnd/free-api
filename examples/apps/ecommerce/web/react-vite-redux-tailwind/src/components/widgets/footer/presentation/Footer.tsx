      ...
      <div className={`flex justify-between`} dir={isRTL ? "rtl" : "ltr"}>
        ...
        >
          <div className="flex flex-col text-zinc-50">
            <Text className="break-words text-base capitalize">
              {t("companyAddress")}
            </Text>
            <Text className="mt-4">{t("companyEmail")}</Text>
            <Text className="mt-4">{t("companyPhone")}</Text>
          </div>
        </FooterSection>
      </div>
      <Text className="text-zinc-50 flex justify-center pb-4 capitalize">
        {t("copyrightMessage")}
      </Text>
    </footer>
  );
